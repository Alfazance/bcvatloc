report 70140941 "UAEVATLoc Service Order"
{
    // version NAVW112.00

    DefaultLayout = RDLC;
    RDLCLayout = './UAEVATLoc Service Order.rdl';
        ...
        dataitem("Service Header";"Service Header")
        {
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    column(VATPercCaptionLbl; VATPercentageCaptionLbl)
                    {
                    }
                    column(VATAmtCaptionLbl;VATAmountCaptionLbl)
                    {
                    }
                    column(VATRegCaptionLbl; VATRegNoCaptionLbl)
                    {
                    }
                    column(VATRegNo_CompInfo;CompanyInfo."VAT Registration No." )
                    {
                    }
                    column(VATRegNo_Customer;CustomerRec."VAT Registration No.")
                    {
                    }
            ...
            begin
                ...
                //UAE VAT Localization Start -->
                CustomerRec.Get("Service Header"."Customer No.");
                IsFCY := FALSE;
    ...
    begin
        CompanyInfo.GET;
        ServiceSetup.GET;
        GLSetup.GET;    //UAE VAT Localization
    ...
    var
        ...
        VATRegNoCaptionLbl : Label 'TRN No.';
