report 70140937 "UAEVATLoc Purchase - Invoice"
{
    // version NAVW112.00

    DefaultLayout = RDLC;
    RDLCLayout = './UAEVATLoc Purchase - Invoice.rdl';
    ...
    var
        ...
        Text004: Label 'Purchase - Tax Invoice %1', Comment='%1 = Document No.';
        //UAE VAT Localization Stop <--
        ...
        Text010: Label 'Purchase - Prepayment TAX Invoice %1', Comment='%1 = Document No.';
        //UAE VAT Localization Stop ,--
        OutputNo: Integer;
